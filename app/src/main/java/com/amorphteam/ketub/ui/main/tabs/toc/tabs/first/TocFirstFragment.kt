package com.amorphteam.ketub.ui.main.tabs.toc.tabs.first
...
import com.amorphteam.ketub.databinding.FragmentTocFirstBinding
...
class TocFirstFragment : Fragment() {

    private lateinit var binding: FragmentTocFirstBinding
    private lateinit var viewModel: TocFirstViewModel
    ...
    override fun onCreateView(
        ...
        viewModel = ViewModelProvider(this)[TocFirstViewModel::class.java]
        binding = DataBindingUtil.inflate(
            inflater, R.layout.fragment_toc_first, container, false
        )
