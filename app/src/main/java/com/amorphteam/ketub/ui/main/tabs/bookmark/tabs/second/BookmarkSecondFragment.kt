...
import com.amorphteam.ketub.databinding.FragmentBookmarkSecondBinding
...
class BookmarkSecondFragment : Fragment() {

    private lateinit var binding: FragmentBookmarkSecondBinding
    private lateinit var viewModel: BookmarkSecondViewModel
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater, R.layout.fragment_bookmark_second, container, false
        )

        // Create an instance of the ViewModel Factory.
        val application = requireNotNull(this.activity).application
        val dataSource = BookmarkDatabase.getInstance(application).bookmarkDatabaseDao
        val viewModelFactory = BookmarkSecondViewModelFactory(dataSource)

        // Get a reference to the ViewModel associated with this fragment.
        viewModel =
            ViewModelProvider(this, viewModelFactory)[BookmarkSecondViewModel::class.java]
