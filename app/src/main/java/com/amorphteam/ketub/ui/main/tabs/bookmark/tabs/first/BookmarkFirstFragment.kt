...
import com.amorphteam.ketub.databinding.FragmentBookmarkFirstBinding
...
class BookmarkFirstFragment : Fragment() {

    private lateinit var binding: FragmentBookmarkFirstBinding
    private lateinit var viewModel: BookmarkFirstViewModel
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater, R.layout.fragment_bookmark_first, container, false
        )

        // Create an instance of the ViewModel Factory.
        val application = requireNotNull(this.activity).application
        val dataSource = BookmarkDatabase.getInstance(application).bookmarkDatabaseDao
        val viewModelFactory = BookmarkFirstViewModelFactory(dataSource)

        // Get a reference to the ViewModel associated with this fragment.
        viewModel =
            ViewModelProvider(this, viewModelFactory)[BookmarkFirstViewModel::class.java]
